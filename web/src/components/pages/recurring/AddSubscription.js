...
function AddSubscription() {
  ...
  const [plan_options, setPlanOption] = useState([]);
    ...
    ServerApi.request({
      ...
      (data) => {
        ...
        if (data.status) {
          ...
          setSuccessMsg("Subscription was added successfuly!");
          setSnakeOpen(true);
        } else {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={8} md={6} className={classes.formgroup}>
          ...
          <form noValidate autoComplete="off">
            ...
            <Grid container spacing={2} className={classes.formLow}>
              <Grid item xs={12} sm={3} className={classes.inputlabel}>
                <InputLabel htmlFor="plan_id">Select Plan</InputLabel>
              </Grid>
              <Grid item xs={12} sm={9}>
                <FormControl className={classes.inputbox}>
                  <Select
